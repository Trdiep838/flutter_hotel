      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.only(left: 20.0, top: 20.0),
            child: Text(
              'The space at the hotel is extremely clean and cool. The service attitude of the staff is very enthusiastic.'
                  ' The hotel also has a cargo ferry and a convenient coffee shop for guests’ needs.',
              style: TextStyle(
                color: Colors.grey,
              ),
            ),
