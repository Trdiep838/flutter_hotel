        ...
        body: ListView(
          ...
          //  hotelPreview(),
            ...
            InkWell(
              ...
              //     MaterialPageRoute(builder: (context) => HotelDetails())),HotelDetails
              child: Padding(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: ListView(
            ...
            children: <Widget>[
              checkInListTile(true, "Location", "Nha Trang", Icons.location_on),
              SizedBox(
                height: 20,
              ),
              Row(
                ...
                children: <Widget>[
                  Expanded(
                    flex: 2,
                    child: checkInListTile(true, "Check in", "01.02.2022", Icons.card_travel),),
                  Expanded(
                    flex: 1,
                    child: Container(
                      height: 60,
                  ...
                  Expanded(
                    child: checkInListTile(false, "Check out", "10.02.2022", Icons.location_on),
                  ),
                ],
              ),
              SizedBox(
              ...
              checkInListTile(true, "Person", "2 adult", Icons.people),
              SizedBox(
                height: 20,
              ),
